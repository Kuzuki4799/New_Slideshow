...
class TextureRenderer(val effectCode: String="", val isExternalEOS: Boolean = true) {
    ...
    private val vidVertexShaderCode =
        ...
        void main()
        {
            vTextureCoord = (texMatrix * vec4(uvs.x, uvs.y, 0, 1.0)).xy;
    ...
    init {
        ...
        val fragCode = if (isExternalEOS) getFragmentShader(effectCode) else textFragmentShaderCode
        Logger.e("frag ment code = $fragCode")
        ...
        program = GLES20.glCreateProgram().also {
            ...
            samplerHandle = GLES20.glGetUniformLocation(it, "sTexture")
        }
    ...
    fun draw(mvpMatrix: FloatArray,
        ...
        if(isExternalEOS) {
            val motionLocation = GLES20.glGetUniformLocation(program, "_motion")
    ...
    private fun getFragmentShader(effectCode: String):String {
